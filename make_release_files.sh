...
cd ./tools/rnduser0/
rm CARD_Desc.bytes CARD_Desc.bytes.dec CARD_Desc.bytes.dec.json CARD_Indx.bytes CARD_Indx.bytes.dec CARD_Name.bytes CARD_Name.bytes.dec CARD_Name.bytes.dec.json Card_Part.bytes Card_Part.bytes.dec Card_Pidx.bytes Card_Pidx.bytes.dec
cp -r ../rebundle/bytes/* .
...
cp "./tools/rnduser0/Card_Pidr.bytes.dec" "./data/Card_Pidx.bytes.dec"
...
rm -rf release
mkdir release
cp -r ./tools/rebundle/uninstall ./release/uninstall
